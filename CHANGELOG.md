...
- Change the "read_hit1_genus_fraction" and "read_hit1_species_fraction" thresholds to FAIL under 0.9 instead of 0.95, in accordance to ASU L 00.00-183. Values between 0.9 and 0.95 will issue a WARNING.
